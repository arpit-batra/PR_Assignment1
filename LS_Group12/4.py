...
def main():
    ...
    det1 = ( (cov_mat_class1[0][0]*cov_mat_class1[1][1]) - (cov_mat_class1[0][1]*cov_mat_class1[1][0]) )
    # print(det1)
    temp = cov_mat_class1[0][0]
    cov_mat_class1[0][0] = cov_mat_class1[1][1]
    cov_mat_class1[1][1] = temp;
    cov_mat_class1[1][0] = -1*cov_mat_class1[1][0]
    cov_mat_class1[0][1] = -1*cov_mat_class1[0][1]

    # for inverse of matrix switch left to right diagonal values and inverse sign of other elements of diagonal
    # and divide by determinant det = a*c-b*d

    for i in range(d):
        for j in range(d):
            cov_mat_class1[i][j]/=det1
    ...
    det2 = ( (cov_mat_class2[0][0]*cov_mat_class2[1][1]) - (cov_mat_class2[0][1]*cov_mat_class2[1][0]) )
    # print(det2)
    temp = cov_mat_class2[0][0]
    cov_mat_class2[0][0] = cov_mat_class2[1][1]
    cov_mat_class2[1][1] = temp;
    cov_mat_class2[1][0] = -1*cov_mat_class2[1][0]
    cov_mat_class2[0][1] = -1*cov_mat_class2[0][1]
    ...
    det3 = ( (cov_mat_class3[0][0]*cov_mat_class3[1][1]) - (cov_mat_class3[0][1]*cov_mat_class3[1][0]) )
    # print(det3)
    temp = cov_mat_class3[0][0]
    cov_mat_class3[0][0] = cov_mat_class3[1][1]
    cov_mat_class3[1][1] = temp;
    cov_mat_class3[1][0] = -1*cov_mat_class3[1][0]
    cov_mat_class3[0][1] = -1*cov_mat_class3[0][1]
    ...
    w0_12 -= (log(pow(det1,2)/pow(det2,2)))/2;
    print(w0_12)    
    ...
    w0_13 -= (log(pow(det1,2)/pow(det3,2)))/2;
    print(w0_13)    
    ...
    w0_23 -= (log(pow(det2,2)/pow(det3,2)))/2;
    print(w0_23)    
